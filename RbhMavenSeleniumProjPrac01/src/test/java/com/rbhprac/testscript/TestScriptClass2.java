...
public class TestScriptClass2 extends BaseClass {
	
	WebDriverCommonLib wlib = new WebDriverCommonLib();
	@Test
	public  void doSomethingClass2() throws IOException, InterruptedException {
		
		JavascriptExecutor jse = (JavascriptExecutor)driver.get();
		jse.executeScript("window.scrollBy(0,document.body.scrollHeight)");
	   //Thread.sleep(2000);
		wlib.waitForElement(driver.get(), driver.get().findElement(By.xpath("//a[text()='Careers']")));
		driver.get().findElement(By.xpath("//a[text()='Careers']")).click();
		//Thread.sleep(2000);
